...
#  Проверьте диапазон (start должен быть больше чем end,
#  если это не так, поменяйте их местами через множественное присваивание)
#  Выполните цикл с уже обработанными данными)
